...
def create_schema(table_schema: str) -> TableSchema:
    ...
    if table_schema == 'daily_prices':
        ...
        schema = TableSchema(
            ...
            columns=[
                Column('id', 'INTEGER', description="Unique ID for the news item (auto-increment)"),
                Column('symbol', 'TEXT', description="Stock symbol"),
                Column('datetime', 'TIMESTAMP', description="Publication date and time"),
                ...
                Column('length_summary', 'INTEGER', description="Length of the news summary"),
                Column('url', 'TEXT', description="URL to the news article"),
                Column('sentiment', 'TEXT', description="Sentiment label for the specific ticker"),
                Column('sentiment_score', 'REAL', description="Sentiment score for the specific ticker"),
                Column('overall_sentiment', 'TEXT', description="Overall sentiment label for the news item"),
                Column('overall_sentiment_score', 'REAL', description="Overall sentiment score for the news item"),
                Column('created_at', 'TIMESTAMP', description="When the record was created"),
                Column('relevance_score', 'REAL', description="Relevance score for the news item")
            ],
            primary_keys=['id'],
